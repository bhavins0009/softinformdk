            ...
            <div class="tb-right">
                ...
                <div class="lang">
                    ...
                    <ul style="display: none">
                        <li><a href="<?php echo network_site_url()?>"><img alt="Danish Flag" src="<?php echo get_template_directory_uri() ?>/images/dan-flag.png">Danish</a></li>
    ...
    <div class="middlebar">
        <div class="container">
            ...
            <nav class="nav">
                ...
                <ul class="nav-ul">
                    <li class="<?php echo $rootUrlLinkActive; ?>"><a href="index.php">Home</a></li>
