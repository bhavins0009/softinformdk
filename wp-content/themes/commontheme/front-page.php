...
<div class="hero-section">
    ...
    <div class="caption">
        <div class="inner">
            ...
            <a  href=" <?php echo get_field('banner_button_link') ?>" class="btn btn-round"><span>Læs mere</span></a>
        </div>
    </div>
</div>
<section class="fr">
    <div class="container">
        ...
        <div class="text-center">
            <a href="<?php echo get_field('feature_button_link') ?>" class="btn"><span>Kontakt os</span></a>
        </div>
    </div>
</section>
<section class="video-sec">
    <div class="container">
        ...
        <div class="one-half" data-aos-delay="100"  data-aos="fade-down" data-aos-easing="ease-in-cubic">
            ...
            <a href="<?php echo get_field('video_section_link') ?>" class="btn"><span>Læs mere</span></a>
        </div>
    </div>
</section>
...
<section class="choose-sec">
    <div class="container">
        <h2><span>HVORFOR SKAL DU VÆLGE <i class="softinform-text">SOFT<sub>&#8226;</sub>INFORM?</i></span></h2>
        <ul>
            <?php
            $i=100;
...
<section class="testimonials">
    <div class="container" data-aos-delay="100"  data-aos="zoom-in" data-aos-easing="ease-in-cubic">
        <h2><span>Succes historier fra vores medarbejdere</span></h2>
